...
def random_forest(X_train, y_train, X_test,  y_test):
    rf = RandomForestClassifier(n_estimators=100, max_depth=4,min_samples_leaf=1,\
...
if __name__ == '__main__':
    ...
    df['label'] = (df.percentage > 0.5).astype(int)
    # 'average_contribution'
    df_X = df[['friends','days','goal','shares','story_length','title_length']]
    y = df['label']
    X = df_X.values
